...
function shuffleCardImageClasses() {
  ...
  let shuffledDeck = _.shuffle(newDeck);
...
function createCards(parentElement, shuffledImageClasses) {
  ...
  for (i = 0; i < 12; i++) {
    ...
    let newClass = shuffledImageClasses[i];
...
let gameMusic = new Audio('audio/zelda.mp3');
...
function onCardFlipped(newlyFlippedCard) {
  ...
  } else if (newlyFlippedCard.imageClass != lastCardFlipped.imageClass) {
    //console.log('lastCardFlipped=' + lastCardFlipped.classList + "\nnewlyFlippedCard=" + newlyFlippedCard);
